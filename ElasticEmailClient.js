function EEAPI(options) {
    ...
    var cfg = $.extend({
        ...
        ApiKey: "e3016bf8-a5fa-4677-a5fd-e07ecf9545ec",
        Version: 2,
        TimeOut: 30000,
        beforeSend: function () {
        },
     ...
     * @param {Boolean} enableContactFeatures - True, if you want to use Contact Delivery Tools.  Otherwise, false
     ...
     * @param {Function} callback
     */
    account.RequestPremiumSupport = function (callback) {

        request('/account/requestpremiumsupport', {}, callback, 'POST');
    };
     ...
     * @return {String}
     */
    contact.Add = function (publicAccountID, email, publicListID, listName, firstName, lastName, source, returnUrl, sourceUrl, activationReturnUrl, activationTemplate, sendActivation, consentDate, consentIP, field, notifyEmail, callback) {
        ...
        request('/contact/add', {publicAccountID: publicAccountID, email: email, publicListID: publicListID, listName: listName, firstName: firstName, lastName: lastName, source: source, returnUrl: returnUrl, sourceUrl: sourceUrl, activationReturnUrl: activationReturnUrl, activationTemplate: activationTemplate, sendActivation: sendActivation, consentDate: consentDate, consentIP: consentIP, field: field, notifyEmail: notifyEmail}, callback, 'POST');
    };
     ...
     * @param {Function} callback
     */
    contact.ChangeStatus = function (status, rule, emails, callback) {
        rule = typeof rule !== 'undefined' ? rule : null;
        emails = typeof emails !== 'undefined' ? emails : null;
        request('/contact/changestatus', {status: status, rule: rule, emails: emails}, callback, 'POST');
    };
     ...
     * @param {Function} callback
     * @return {ContactUnsubscribeReasonCounts}
     */
    contact.CountByUnsubscribeReason = function (callback) {

        request('/contact/countbyunsubscribereason', {}, callback, 'POST');
    };
     ...
     * @param {Function} callback
     */
    contact.Delete = function (rule, emails, callback) {
        rule = typeof rule !== 'undefined' ? rule : null;
        emails = typeof emails !== 'undefined' ? emails : null;
        request('/contact/delete', {rule: rule, emails: emails}, callback, 'POST');
    };
     ...
     * @return {ExportLink}
     */
    contact.Export = function (fileFormat, rule, emails, compressionFormat, fileName, callback) {
        fileFormat = typeof fileFormat !== 'undefined' ? fileFormat : 'csv';
        rule = typeof rule !== 'undefined' ? rule : null;
        emails = typeof emails !== 'undefined' ? emails : null;
        compressionFormat = typeof compressionFormat !== 'undefined' ? compressionFormat : 'none';
        fileName = typeof fileName !== 'undefined' ? fileName : null;
        request('/contact/export', {fileFormat: fileFormat, rule: rule, emails: emails, compressionFormat: compressionFormat, fileName: fileName}, callback, 'POST');
    };
     ...
     * @return {Array.<Contact>}
     */
    contact.List = function (rule, limit, offset, callback) {
        rule = typeof rule !== 'undefined' ? rule : null;
        limit = typeof limit !== 'undefined' ? limit : 20;
        offset = typeof offset !== 'undefined' ? offset : 0;
        request('/contact/list', {rule: rule, limit: limit, offset: offset}, callback, 'POST');
    };
     ...
     * @param {Function} callback
     */
    contact.QuickAdd = function (emails, firstName, lastName, publicListID, listName, status, notes, consentDate, consentIP, field, notifyEmail, callback) {
        firstName = typeof firstName !== 'undefined' ? firstName : null;
        lastName = typeof lastName !== 'undefined' ? lastName : null;
        publicListID = typeof publicListID !== 'undefined' ? publicListID : null;
        listName = typeof listName !== 'undefined' ? listName : null;
        ...
        field = typeof field !== 'undefined' ? field : null;
        notifyEmail = typeof notifyEmail !== 'undefined' ? notifyEmail : null;
        request('/contact/quickadd', {emails: emails, firstName: firstName, lastName: lastName, publicListID: publicListID, listName: listName, status: status, notes: notes, consentDate: consentDate, consentIP: consentIP, field: field, notifyEmail: notifyEmail}, callback, 'POST');
    };
     ...
     * @return {Contact}
     */
    contact.Update = function (email, firstName, lastName, clearRestOfFields, field, customFields, callback) {
        firstName = typeof firstName !== 'undefined' ? firstName : null;
        lastName = typeof lastName !== 'undefined' ? lastName : null;
        clearRestOfFields = typeof clearRestOfFields !== 'undefined' ? clearRestOfFields : true;
        field = typeof field !== 'undefined' ? field : null;
        customFields = typeof customFields !== 'undefined' ? customFields : null;
        request('/contact/update', {email: email, firstName: firstName, lastName: lastName, clearRestOfFields: clearRestOfFields, field: field, customFields: customFields}, callback, 'POST');
    };
     ...
     * @param {Function} callback
     */
    list.MoveContacts = function (oldListName, newListName, emails, moveAll, statuses, rule, callback) {
        emails = typeof emails !== 'undefined' ? emails : null;
        moveAll = typeof moveAll !== 'undefined' ? moveAll : null;
        statuses = typeof statuses !== 'undefined' ? statuses : null;
        rule = typeof rule !== 'undefined' ? rule : null;
        request('/list/movecontacts', {oldListName: oldListName, newListName: newListName, emails: emails, moveAll: moveAll, statuses: statuses, rule: rule}, callback, 'POST');
    };
     ...
     * @return {ExportLink}
     */
    log.Export = function (statuses, fileFormat, from, to, channelName, limit, offset, includeEmail, includeSms, messageCategory, compressionFormat, fileName, email, callback) {
        fileFormat = typeof fileFormat !== 'undefined' ? fileFormat : 'csv';
        from = typeof from !== 'undefined' ? from : null;
        to = typeof to !== 'undefined' ? to : null;
        channelName = typeof channelName !== 'undefined' ? channelName : null;
        ...
        request('/log/export', {statuses: statuses, fileFormat: fileFormat, from: from, to: to, channelName: channelName, limit: limit, offset: offset, includeEmail: includeEmail, includeSms: includeSms, messageCategory: messageCategory, compressionFormat: compressionFormat, fileName: fileName, email: email}, callback, 'POST');
    };
     ...
     * @return {ExportLink}
     */
    log.ExportLinkTracking = function (from, to, channelName, fileFormat, limit, offset, compressionFormat, fileName, callback) {
        channelName = typeof channelName !== 'undefined' ? channelName : null;
        fileFormat = typeof fileFormat !== 'undefined' ? fileFormat : 'csv';
        limit = typeof limit !== 'undefined' ? limit : 0;
        offset = typeof offset !== 'undefined' ? offset : 0;
        compressionFormat = typeof compressionFormat !== 'undefined' ? compressionFormat : 'none';
        fileName = typeof fileName !== 'undefined' ? fileName : null;
        request('/log/exportlinktracking', {from: from, to: to, channelName: channelName, fileFormat: fileFormat, limit: limit, offset: offset, compressionFormat: compressionFormat, fileName: fileName}, callback, 'POST');
    };
